  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="py-5">
        <div class="container-fluid">
          <div class="row">
               <h3 class='h4 text-dark text-uppercase fw-normal'>Resident Dashboard Archive</h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="residentmanagement.php" style="color: black;">Manage</a></li>
        ...
        <div class="container-fluid">
          ...
          <div class="card-body">
            <div class="card-header">
                 <h3 class="card-title">Archived Resident List</h3> 
    ...
    if(isset($_POST['search']))
    {
        ...
        $query = "SELECT * FROM `residenttbl` WHERE Status = '0' AND CONCAT(`RID`, `Username`, `Password`, `Firstname`, `Middlename`, `Lastname`, `Birthdate`, `Address`, `CivilStatus`, `Status`, `Age`, `Gender`, `Income`, `Occupation`, `SResidency`, `EResidency`, `Remarks`, `ContactNum`, `FamilyStats`, `FamilyName`, `Certificate`) LIKE '%".$valueToSearch."%'";
        $search_result = filterTable($query);
        
    }
     else {
        $query = "SELECT * FROM `residenttbl` WHERE Status = '0'";
        $search_result = filterTable($query);
    }
    ...
    ?>
      ...
      <form action="arresidentmanagement.php" method="post">
                                    <div class="input-group mb-3">
                                        <input type="text" name="valueToSearch" placeholder="Search data" style="text-transform: capitalize;">
            ...
            <p>
              <button class="btn btn-primary TablePrinting" id="TablePrinting">Print Table</button>
                ...
                <table id='tblArRes' class='table table-bordered table-striped' style="text-align:center;">
                ...
                include ("condb.php");
                 ...
                 echo "<td>" . $row['RID'] . " </td> ";
                  ...
                  echo "<td><button type='button' class='open-edit btn btn-success btn-xs'><i class='fa fa-trash-restore'></i></button>
                  ...
                  echo "</tr>";
                      ...
                      echo" <div class='modal fade' id='edit'>
                        <div class='modal-dialog modal-md'>"; 
                          echo " <form action='resRestore.php?id=" . $row2['RID'] . "' method='POST'>
                          <div class='modal-content'>
                            <div sclass='modal-header'>
                              <h4 class='modal-title'>Retrieve User</h4>
                              <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                                <span aria-hidden='true'>&times;</span>
                              </button>
                            </div>
                      ...
                      echo'<div class="col-12">
                            <label for="">Resident ID</label>
                                 <input style = "text-align:center" type="text" name = "ID" id = "ID" class="form-control" readonly>
                              </div>';
                      
                     echo'<div class="col-12">
                            <label for="">Firstname</label>
                           <input type="text" name = "fname" id = "fname" class="form-control" placeholder="Enter Firstname" style = "text-align:center" readonly>
                        </div>';
                     echo'<div class="col-12">
                             <label for="">Middlename</label>
                          <input type="text" name = "mname" id = "mname" class="form-control" placeholder="Enter Middlename" style = "text-align:center" readonly>
                        </div>';
                     echo '<div class="col-12">
                                  <label for="">Lastname</label>
                          <input type="text" name = "lname" id = "lname" class="form-control" placeholder="Enter Lastname" style = "text-align:center" readonly>
                        </div>';
...
<script>
  $('.TablePrinting').click(function(){
    var printme = document.getElementById('tblArRes');
