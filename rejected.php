  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="py-5">
        <div class="container-fluid">
          <div class="row">
               <h3 class='h4 text-dark text-uppercase fw-normal'>Rejected 4p's Application Dashboard</h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              
              <li class="breadcrumb-item"><a href="approvemanagement.php" style="color: black;">Approved</a></li>
    ...
    if(isset($_POST['search']))
    {
        ...
        $query = "SELECT * FROM `4ps` WHERE Status = '0' AND Declined = '1' AND CONCAT(`CID`, `RID`, `Status`, `Approved`, `Declined`, `Application`, `Yearly`, `Remarks`) LIKE '%".$valueToSearch."%'";
        $search_result = filterTable($query);
        
    }
     else {
        $query = "SELECT * FROM `4ps` WHERE Status = '0' AND Declined = '1' ORDER BY CID";
        $search_result = filterTable($query);
    }
            ...
            <p>
              <button class="btn btn-primary TablePrinting" id="TablePrinting">Print Table</button>
                ...
                include ("condb.php");
                  ...
                  echo "<td style='text-transform: capitalize;' >" . $row['Remarks'] . " </td> ";
                  echo "</form>";
                  echo "</tr>";
                }
                   ?>
