      ...
      <section class="bg-white py-5">
        <h1 class="m-0" style="text-align: center; color: black;">Functionality of BPOC</h1>
            <p style="text-align: center; color: black;">Barangay: DUYAY-YAT<br>Municipality: SINAIT<br>Province: Ilocos Sur</p>
                ...
                <form method="POST" action="BPOCApplication.php" enctype="multipart/form-data">

                  <div style="padding-left: 30px;">
                    <div class="row-center">
                        <div class="col-6">
                                  <label for="">REORGANIZATION REACTIVATION OF BPOC</label>
                        ...
                        <div class="row-center">
                        	        <p style="text-align: center; color: black;">BRGY PUBLIC SAFETY PLAN</p>
                         <hr>
                        <div class="col-6">
                        ...
                        <div class="row-center">
                        <div class="col-6">
                                  <label for="">WITH COMPLETE CONTENTS PER DILG MC# 2002-05</label>
