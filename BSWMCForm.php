    ...
    <div class="page">
     ...
     <section class="py-5">
      ...
      <section class="bg-white py-5">
        <h1 class="m-0" style="text-align: center; color: black;">Functionality of BSWMC</h1>
            <p style="text-align: center; color: black;">Barangay: DUYAY-YAT<br>Municipality: SINAIT<br>Province: Ilocos Sur</p>
            
                <form method="POST" action="BSWMCApplication.php" enctype="multipart/form-data">

                  <div style="padding-left: 30px;">
                    <div class="row-center">
                        <div class="col-6">
                                  <label for="">REORGANIZATION REACTIVATION OF BSWMC (BSWMC EO)</label>
