...
<script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js'></script>
  ...
  <body>
        ...
        <div class="container-fluid">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Manage</a></li>
              <li class="breadcrumb-item"><a href="arresidentmanagement.php" style="color: black;">Archive</a></li>
            </ol>
          </div>
        </div>
      </section>
                          ...
                          <br>
                              ...
                              <?php
                                ...
                                while($row = mysqli_fetch_assoc($result))
                                  ...
                                  echo'<option style="text-transform: capitalize;" value="'.$row['FamilyID'].'">'.$Fullname.'</option>
                                    ';
                                }?>
                          </select>
                        </div>
    ...
    <div id="myBtnContainer">
                             <form action="residentmanagement.php" method="post">
        ...
        <div class="container">
          ...
          <form action="readyPrintResident.php" style="margin-bottom: -90px;margin-left: -180px;">
            <button class="btn btn-primary" type="submit">Ready table for Printing</button>
          </form>
        </div>
<form action="sortres.php?" method="post">
       <table border="0" cellspacing="5" cellpadding="5" style="margin-left: 1000px;">
        <tbody><tr>
            <td>Minimum age:</td>
        ...
        <tr>
            ...
            <td><input type="submit" class="btn btn-primary" name="search" value="Sort Age"></td>
                ...
                <table id='tblresident' class='table table-bordered table-striped'>
                  <caption style="text-align: center;">Republic of the Philippines<br>Province of Ilocos Sur <br>Municipality of Sinait<br>Barangay DUYAY-YAT</p>
</caption>
<img src="">
                ...
                include ("condb.php");
                 ...
                 $sql = "SELECT * FROM residenttbl WHERE Status = '1' AND CONCAT(RID,Firstname,Middlename,Lastname,Age,Address,Gender,CivilStatus,Occupation,Income,FamilyName,FamilyStats) LIKE '%$filtervalues%' ";
                  ...
                  echo "<td style='text-transform: capitalize;'>" . $row['RID'] . " </td> ";
                  ...
                  echo "<td style='text-transform: capitalize;'>" . $row['CivilStatus'] . " </td> ";
                  echo "<td style='text-transform: capitalize;'>" . $row['Occupation'] . " </td> ";
                  echo "<td>" . $row['Income'] . " </td> ";
                  echo "<td style='text-transform: capitalize;'>" . $row['FamilyStats'] . " </td> ";
                  echo "<td style='text-transform: capitalize;'>" . $row['FamilyID'] . " </td> ";
