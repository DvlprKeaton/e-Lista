                ...
                <div class="modal fade" id="add">
                      ...
                      <div class="row">
                         ...
                         <div class="col-12">
                          ...
                          <input type="text" name="famhname" class="radio1" disabled="true" />
                        ...
                        <div class="col-12"> 
                          ...
                          <br>
                              ...
                              <option value="0" required> - SELECT FAMILY NAME - </option>
                              <?php
                                ...
                                while($row = mysqli_fetch_assoc($result))
                                  ...
                                  echo'<option value="'.$FamName.'">'.$FamName.'</option>
                                    ';
                                }?>
                          </select>
                        </div>
...
<form action="sortres.php" method="post">
       <table border="0" cellspacing="5" cellpadding="5">
        <tbody><tr>
            <td>Minimum age:</td>
            <td><input type="text" id="minAge" name="minAge"></td>
        </tr>
        <tr>
            <td>Maximum age:</td>
            <td><input type="text" id="maxAge" name="maxAge"></td>
            <td><button class="btn btn-primary" onclick="ageSort()">Sort Age</button></td>
        </tr>
    </tbody></table>
</form>
              ...
              $max = $_POST['maxAge'];
                  ...
                  echo $min;
                  echo $max;
                  $sql = "SELECT * FROM residenttbl WHERE Status = '1' AND Age BETWEEN '$min' AND '$max' ORDER BY RID";
                  $result = mysqli_query($cn, $sql);
                  while($row = mysqli_fetch_assoc($result))
                  {
