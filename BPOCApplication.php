...
<body>
  <img src="img/fLogo1.jpg" style="object-position: left;position: absolute;width: 150px; height: 150px;margin-right: 350px;">
    ...
    <p style="text-align:center;position: absolute;right: 320px;font-weight: bold;">Republic of the Philippines<br>Municipality of Sinait, Duyay-yat<br>Ilocos Sur, 2733</p>

<h1 class="m-0" style="text-align: center; color: black;">Functionality of BPOC</h1>
...
<table class="table table">
  ...
  <thead>
    <tr>
      <th scope="col">REORGANIZATION REACTIVATION OF BPOC</th>
      <th scope="col">RESOLUTION #</th>
      <th scope="col">DATE ENACTED</th>
      <th scope="col">WITH COMPLETE CONTENTS PER DILG MC# 2002-05</th>
      ...
      <th scope="col">NUMBER OF CSO/NGO ATTENDING THE MEETING</th>
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo  $entry8;?></td>
  </tbody>
</table>

<p style="text-align:left;margin-top: 50px;text-transform: capitalize;">Prepared By: <?php echo $row['Lastname']. ', '. $row['Firstname'];?></p>
<p style="text-align:Right;margin-top: 50px;text-transform: capitalize;">Approved by: <?php echo $row2['Lastname']. ', '. $row2['Firstname'];?></p>
...
$mpdf->WriteHTML($html);
$mpdf->Output('FunctionalityOfBPOC.pdf','D');
