...
<script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js'></script>
        ...
        <div class="container-fluid">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="barangaymanagement.php" style="color: black;">Manage</a></li>
        ...
        <div class="container-fluid">
          ...
          <div class="card-body">
            <div class="card-header">
                <h3 class="card-title">Archived Barangay Official List</h3>
  ...
  title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters"required>
    ...
    if(isset($_POST['search']))
    {
        ...
        $query = "SELECT * FROM `officialstbl` WHERE Status = '0' AND CONCAT(`BID`, `Username`, `Password`, `Firstname`, `Middlename`, `Lastname`, `Birthdate`, `Position`, `Address`, `Status`, `Age`, `Gender`, `Term`) LIKE '%".$valueToSearch."%'";
        $search_result = filterTable($query);
        
    }
     else {
        $query = "SELECT * FROM `officialstbl` WHERE Status = '0'";
        $search_result = filterTable($query);
    }
    ...
    ?>
      ...
      <form action="arbarangaymanagement.php" method="post">
            ...
            <p>
              <button class="btn btn-primary TablePrinting" id="TablePrinting">Print Table</button>
                ...
                <table id='tblArBar' class='table table-bordered table-striped' style="text-align:center;">
          ...
          echo "<td><button type='button' class='open-edit btn btn-success btn-xs'><i class='fa fa-pencil-alt'></i></button>
                    </td></form>";
          echo "</tr>";
                }
                      ...
                      echo" <div class='modal fade' id='edit'>
                        <div class='modal-dialog'>"; 
                          echo " <form action='restore.php?id=" . $row2['BID'] . "' method='POST'>
                          <div class='modal-content'>
                            <div class='modal-header'>
                     ...
                     echo'<div class="col-12">
                            <label for="">Firstname</label>
                           <input style = "text-align:center" type="text" name = "fname" id = "fname" class="form-control" placeholder="Enter Firstname" readonly>
                        </div>';
                     echo'<div class="col-12">
                             <label for="">Middlename</label>
                          <input style = "text-align:center"type="text" name = "mname" id = "mname" class="form-control" placeholder="Enter Middlename" readonly>
                        </div>';
                     echo '<div class="col-12">
                                  <label for="">Lastname</label>
                          <input style = "text-align:center" type="text" name = "lname" id = "lname" class="form-control" placeholder="Enter Lastname" readonly>
                        </div>                        <hr>';
...
<script>
  $('.TablePrinting').click(function(){
    var printme = document.getElementById('tblArBar');
